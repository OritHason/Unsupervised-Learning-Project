...
def plot_figure_1():
    ...
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_with_remote, target_column=None, ax=a2, ax_title='t-SNE',
                          method='tsne', prefix='Dim', explanation_prefix='Dimension')
    ...
    reduced_data_tsne_with_remote = add_target_data(data=reduced_data_tsne_with_remote, target_data=remote_data,
                                                    target_column='Remote_Work')
    reduced_data_tsne_with_remote = add_target_data(data=reduced_data_tsne_with_remote, target_data=work_life_data,
                                                    target_column='Work_Life_Balance')
    reduced_data_tsne_with_remote = add_target_data(data=reduced_data_tsne_with_remote, target_data=job_level_data,
                                                    target_column='Job_Level')
    reduced_data_pca_with_remote = add_target_data(data=reduced_data_pca, target_data=remote_data,
                                                   target_column='Remote_Work')
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_with_remote, target_column='Remote_Work', labels=remote_labels,
                          ax=a3, ax_title='Remote work', method='tsne', prefix='Dim', explanation_prefix='Dimension')
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_with_remote, target_column='Work_Life_Balance',
                          labels=work_life_labels, ax=a4, ax_title='Work life balance', method='tsne', prefix='Dim',
                          explanation_prefix='Dimension')
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_with_remote, target_column='Job_Level', labels=job_level_labels,
                          ax=a5, ax_title='Job level', method='tsne', prefix='Dim', explanation_prefix='Dimension')
    ...
    processed_data_no_remote, t, tc_ = preprocess_data_for_dim(data=data_no_remote, target_column=None,
                                                               data_features=feature_in_data_no_remote)
    ...
    reduced_data_tsne_without_remote = add_target_data(data=reduced_data_tsne_without_remote,
                                                       target_data=work_life_data, target_column='Work_Life_Balance')
    reduced_data_tsne_without_remote = add_target_data(data=reduced_data_tsne_without_remote,
                                                       target_data=job_level_data, target_column='Job_Level')
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_without_remote, target_column='Work_Life_Balance',
                          labels=work_life_labels, ax=a6, ax_title='Work life balance', method='tsne', prefix='Dim',
                          explanation_prefix='Dimension')
    plot_2d_scatter_on_ax(pca_df=reduced_data_tsne_without_remote, target_column='Job_Level', labels=job_level_labels,
                          ax=a7, ax_title='Job level', method='tsne', prefix='Dim', explanation_prefix='Dimension')
    plot_2d_scatter_on_ax(pca_df=reduced_data_pca_with_remote, target_column='Remote_Work', labels=remote_labels, ax=a8,
                          ax_title='Remote work', method='pca')
    ...
    processed_data_no_remote_no_job_level, t, tc_ = preprocess_data_for_dim(data=data_no_remote_no_job_level,
                                                                            target_column=None,
                                                                            data_features=feature_in_data_no_remote_no_job_level)
    processed_data_no_remote_no_work_life, t, tc_ = preprocess_data_for_dim(data=data_no_remote_no_work_life,
                                                                            target_column=None,
                                                                            data_features=feature_in_data_no_remote_no_work_life)
